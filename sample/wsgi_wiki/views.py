...
from fapws2.contrib.headers import redirect
from fapws2.base import status_reasons

repository = "repository"
menu = """<a href="/"><img border="0" src="/static/img/house.png" title="Back to home page"/></a>"""
def get_status(code):
